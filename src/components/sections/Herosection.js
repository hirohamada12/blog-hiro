    ...
    return (
        ...
        >
            <div className="container">
                <div className="intro">
                    <img style={{borderRadius: "50%", width: "90px", height: "90px", objectFit: "cover"}}
                         src="images/avatar_hiro.JPG" alt="HiroPna" className="mb-4"/>

                    <h1 className="mb-2 mt-0">Hiro Phan</h1>
                    <p>
                        I'm a{" "}
                        <Typed
                            strings={[
